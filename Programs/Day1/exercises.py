...
print("[1]", name, "who is", age, "years old and height is", height_m, "is currently employed", is_employed)

# 2) Arithmetic & precedence
# Compute simple expression and show precedence using parentheses
# Original: 2 + 3 * 4 ** 2
result1 = 2 + 3 * 4 ** 2  # precedence: ** > * > +
result2 = 2 + (3 * (4 ** 2))  # fully parenthesized
...
greet_fstring = f"{a} {b}"
greet_concat = a + " " + b
print("[5]", greet_fstring, "|", greet_concat)
